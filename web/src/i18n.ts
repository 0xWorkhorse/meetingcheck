...
const en: UiMessages = {
  ...
  sections: {
    ...
    extensionBody: 'Right-click any link → "Check with meetingcheck". Works in Chrome and Firefox. Minimal permissions.',
...
const es: UiMessages = {
  ...
  sections: {
    ...
    extensionBody: 'Click derecho en cualquier enlace → "Verificar con meetingcheck". Funciona en Chrome y Firefox. Permisos mínimos.',
