...
export const en: UiMessages = {
  ...
  hero: {
    ...
    statScamsFlaggedSince: 'scams flagged since {date}',
  },
  ...
  checker: {
    ...
    values: {
      ...
      redirectsFailed: "EXPANSION FAILED",
      charAsciiClean: "ASCII CLEAN",
      charNonAscii: "NON-ASCII",
      charPunycode: "PUNYCODE: {decoded}",
      charSpoof: "SPOOF: {decoded}",
      hostingKnown: "{cc}",
      hostingUnknown: "UNKNOWN",
      hostingUnavailable: "UNAVAILABLE",
      whoisUnavailable: "UNAVAILABLE",
      whoisPrivate: "PRIVATE",
      whoisFresh: "FRESH ({n}D)",
      whoisYoung: "{n}D",
      whoisMature: "> 1Y",
