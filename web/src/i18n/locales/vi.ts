...
export const vi: UiMessages = {
  ...
  checker: {
    ...
    values: {
      ...
      flagged: 'GẮN CỜ {n}×',
      redirectsDirect: "TRỰC TIẾP",
      redirectsHops: "{n} BƯỚC",
      redirectsFailed: "GIẢI MÃ THẤT BẠI",
      charAsciiClean: "ASCII SẠCH",
      charNonAscii: "PHI-ASCII",
      charPunycode: "PUNYCODE: {decoded}",
      charSpoof: "GIẢ MẠO: {decoded}",
      hostingKnown: "{cc}",
      hostingUnknown: "KHÔNG RÕ",
      hostingUnavailable: "KHÔNG CÓ DỮ LIỆU",
      whoisUnavailable: "KHÔNG CÓ DỮ LIỆU",
      whoisPrivate: "RIÊNG TƯ",
      whoisFresh: "MỚI ({n}N)",
      whoisYoung: "{n}N",
      whoisMature: "> 1N",
