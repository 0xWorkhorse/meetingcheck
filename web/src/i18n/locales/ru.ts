...
export const ru: UiMessages = {
  ...
  problem: {
    sectionTag: 'ПРОБЛЕМА',
    heading: 'Твой календарь теперь — это {weapon}.',
    headingWeapon: 'оружие',
    lede:
      'В феврале 2026 тысячи крипто-холдеров кликнули по "приглашению в Zoom", которое им не было. Оно установило перехватчик буфера обмена за то время, пока крутился спиннер загрузки. Кошельки опустели. Звонков никогда не существовало.',
    bodyP1:
      'Настоящие и поддельные ссылки выглядят одинаково для человеческого глаза. {zoomUs} vs {zoomInvite}. {meetGoogle} vs {meetCiom}. {oneLetter} — и кошелька нет.',
    bodyP1OneLetter: 'одна буква',
    bodyP2:
      'Хуже — легитимно выглядящие поддомены (rooms.zoom-partner.xyz) теперь живут на той же инфраструктуре, что и скамы. Адресная строка браузера не помогает. Превью Slack не помогает. Антивирус не помогает, потому что ничего ещё не скачано.',
    bodyP3:
      'Что помогает — это {ruleChecker}: белые списки официальных доменов, прозрачность сертификатов и блоклист сообщества, обновляемый каждые две минуты. Это всё.',
    bodyP3RuleChecker: 'чекер по правилам',
    ledger: {
      ariaLabel: 'Недавние потери',
      date: 'ДАТА',
      incident: 'ИНЦИДЕНТ',
      estLoss: 'ОЦ. ПОТЕРЯ',
      totalLabel: 'ВСЕГО ЗАЯВЛЕНО — ФЕВ ➜ АПР 2026',
    },
  },
