...
export const es: UiMessages = {
  nav: {
    ...
    verdicts: 'Veredictos',
    extension: 'Extensión',
    extensionPopover: "Estamos cocinando, no te vayas ;)",
  ...
  hero: {
    ...
    statLinksChecked: 'enlaces verificados',
    statScamsFlagged: 'estafas marcadas',
  ...
  checker: {
    ...
    signals: {
      ...
      characterCheck: "Comprobación de caracteres",
    ...
    values: {
      ...
      flagged: 'MARCADO {n}×',
      redirectsDirect: "DIRECTO",
      redirectsHops: "{n} SALTOS",
      redirectsFailed: "FALLÓ LA EXPANSIÓN",
      charAsciiClean: "ASCII LIMPIO",
      charNonAscii: "NO ASCII",
      charPunycode: "PUNYCODE: {decoded}",
      charSpoof: "SUPLANTACIÓN: {decoded}",
      hostingKnown: "{cc}",
      hostingUnknown: "DESCONOCIDO",
      hostingUnavailable: "NO DISPONIBLE",
      whoisUnavailable: "NO DISPONIBLE",
      whoisPrivate: "PRIVADO",
      whoisFresh: "NUEVO ({n}D)",
      whoisYoung: "{n}D",
      whoisMature: "> 1A",
      certUnavailable: 'NO DISPONIBLE',
      certNewDomain: 'DOMINIO NUEVO',
      certFresh: 'FRESCO ({n}D)',
