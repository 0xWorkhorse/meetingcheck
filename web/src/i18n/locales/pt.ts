...
export const pt: UiMessages = {
  ...
  hero: {
    ...
    statScamsFlaggedSince: 'golpes sinalizados desde {date}',
  },
  ...
  checker: {
    ...
    signals: {
      ...
      characterCheck: "Checagem de caracteres",
    ...
    values: {
      ...
      redirectsDirect: "DIRETO",
      redirectsHops: "{n} SALTOS",
      redirectsFailed: "FALHA NA EXPANSÃO",
      charAsciiClean: "ASCII LIMPO",
      charNonAscii: "NÃO-ASCII",
      charPunycode: "PUNYCODE: {decoded}",
      charSpoof: "FALSIFICAÇÃO: {decoded}",
      hostingKnown: "{cc}",
      hostingUnknown: "DESCONHECIDO",
      hostingUnavailable: "INDISPONÍVEL",
      whoisUnavailable: "INDISPONÍVEL",
