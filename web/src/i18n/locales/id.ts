...
export const id: UiMessages = {
  ...
  hero: {
    ...
    statScamsFlaggedSince: 'penipuan ditandai sejak {date}',
  },
  ...
  checker: {
    ...
    values: {
      ...
      flagged: 'DITANDAI {n}×',
      redirectsDirect: "LANGSUNG",
      redirectsHops: "{n} LOMPATAN",
      redirectsFailed: "GAGAL DIRESOLUSI",
      charAsciiClean: "ASCII BERSIH",
      charNonAscii: "NON-ASCII",
      charPunycode: "PUNYCODE: {decoded}",
      charSpoof: "PEMALSUAN: {decoded}",
      hostingKnown: "{cc}",
      hostingUnknown: "TIDAK DIKENAL",
      hostingUnavailable: "TIDAK TERSEDIA",
      whoisUnavailable: "TIDAK TERSEDIA",
      whoisPrivate: "PRIVAT",
      whoisFresh: "BARU ({n}H)",
      whoisYoung: "{n}H",
      whoisMature: "> 1TH",
